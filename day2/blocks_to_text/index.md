...
- [Pencil Code: A Programming Primer Book](https://book.pencilcode.net/){:target="_blank"}
- [Digital Technologies Hub: "Design a Flag with Pencil Code" Lesson Idea](http://www.digitaltechnologieshub.edu.au/teachers/lesson-ideas/integrating-digital-technologies/design-a-flag-with-pencil-code){:target="_blank"}
...
- [Code.org's AppLab](https://code.org/educate/applab){:target="_blank"}
